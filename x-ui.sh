...
install() {
    bash <(curl -Ls https://gh-proxy.com/https://raw.githubusercontent.com/GH6324/3xui-cn/main/install.sh)
    if [[ $? == 0 ]]; then
        if [[ $# == 0 ]]; then
            start
        else
...
uninstall() {
    ...
    echo -e "${green}bash <(curl -Ls https://gh-proxy.com/https://raw.githubusercontent.com/GH6324/3xui-cn/master/install.sh)${plain}"
    echo ""
